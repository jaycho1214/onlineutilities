...
export function TextDiffSettingsDialog({
  open,
  onOpenChange,
}: TextDiffSettingsDialogProps) {
              ...
              <div className="grid gap-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/40">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t("settings.ignoreWhitespaceDesc")}
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/40">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <Label
                        htmlFor="ignore-newline"
                        className="text-sm font-medium text-foreground"
                      >
                        {t("settings.ignoreNewlineAtEof")}
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        {t("settings.ignoreNewlineAtEofDesc")}
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/40">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <Label
                        htmlFor="newline-token"
                        className="text-sm font-medium text-foreground"
                      >
                        {t("settings.newlineIsToken")}
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        {t("settings.newlineIsTokenDesc")}
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="p-3 rounded-lg bg-muted/30 border border-border/40">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <Label
                          htmlFor="context-lines"
                          className="text-sm font-medium text-foreground"
                        >
                          {t("settings.contextLines")}:{" "}
                          {state.diffOptions.context ?? 3}
                        </Label>
                        <p className="text-xs text-muted-foreground">
                          {t("settings.contextLinesDesc")}
                        </p>
                      </div>
                    </div>
                    <Slider
