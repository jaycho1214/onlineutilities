...
export const PasswordControls = React.memo<PasswordControlsProps>(
  ({ config, onChange }) => {
    const t = useTranslations("RandomGenerator.password");

    const handleChange = React.useCallback(
      <K extends keyof PasswordConfig>(field: K, value: PasswordConfig[K]) => {
    ...
    const collisionScenarios = React.useMemo(() => {
      ...
      return calculateCollisionScenarios(
        ...
        COMMON_COLLISION_SCENARIOS.password,
      );
