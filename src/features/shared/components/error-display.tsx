...
const errorVariants = {
  ...
  banner: "p-4 bg-red-50 dark:bg-red-950/20 border-l-4 border-red-500 text-red-700 dark:text-red-300",
};
  ...
  <div className={cn("space-y-2", className)}>
    ...
    {(line || column || details) && (
      <div className="text-xs text-red-500 dark:text-red-400 ml-6 space-y-1">
        {line && column && (
          <div>At line {line}, column {column}</div>
        )}
        {line && !column && (
          <div>At line {line}</div>
        )}
        {details && (
