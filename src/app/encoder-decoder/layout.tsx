...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      ...
      description:
        "Powerful encoder/decoder tool supporting Base64, URL encoding, HTML entities, hexadecimal, ASCII, binary, Unicode escape sequences, Punycode, Base58, ROT13, Morse code, and web-specific formats. Features auto-detection, history, and instant conversion.",
      type: "website",
    },
  };
}
...
export default function EncoderDecoderLayout({
  children,
}: EncoderDecoderLayoutProps) {
  return (
